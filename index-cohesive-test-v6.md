...
@media (max-width: 768px) {
  .ss-text-box { width: 100%; padding-right: 0; }
  .ss-image-container { max-width: 100%; }
}
.citation-notes {
  margin-top: 4rem;
  padding-top: 1.5rem;
...
.citation-notes li { margin-bottom: 0.9rem; }
</style>
...
<div style="display:flex; gap:2rem; align-items:flex-start; margin:2rem 0 3rem; flex-wrap:wrap;">

  <img src="{{ site.baseurl }}/assets/images/mystery1.PNG" alt="" style="width:calc(50% - 1rem); height:auto; border-radius:8px; box-shadow:var(--shadow-md);">

  <img src="{{ site.baseurl }}/assets/images/mystery2.PNG" alt="" style="width:calc(50% - 1rem); height:auto; border-radius:8px; box-shadow:var(--shadow-md);">
...
{% include scrollybox/bg-ss-image.html
  ...
  alt-text="Dr. Elizabeth Cushier. Source: Lilian Faderman To Believe in Women."
%}
...
{% include scrollybox/bg-ss-image.html
  ...
  alt-text="Dr. Emily Blackwell. Source: https://www.nyclgbtsites.org/site/new-york-infirmary-for-indigent-women-children/."
%}
...
{% include scrollybox/bg-ss-image.html
  ...
  alt-text="Cushier and Blackwell"
%}
...
{% include scrollybox/bg-ss-image.html
  ...
  alt-text="Letter from Emily Blackwell to Elizabeth Blackwell"
%}
...
The Blackwell family treated Cushier and Blackwell as doctors and as an inseparable pair.[^9]
...
{% include scrollybox/bg-ss-image.html
  ...
  alt-text="Letter from Elizabeth Cushier to Emily Blackwell"
%}
...
[^10]: Ethel Robinson-Blackwell to Emily Blackwell and Elizabeth Cushier, Blackwell Family, Blackwell Family Papers: Other Blackwell Family Papers, -1945; Ethel Blackwell Robinson Papers, 1901 to 1943; Correspondence; Blackwell, Emily. - 1945, 1834. Manuscript/Mixed Material. https://www.loc.gov/item/mss1288002212/.
